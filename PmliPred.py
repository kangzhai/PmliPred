...
# Load data
TrainSequencePath = 'data\\' + splant + '\\Training dataset.fasta' # raw sequence information for training
ListTrainSequence = open(TrainSequencePath, 'r').readlines()
TrainFeaturePath = 'data\\' + splant + '\\Training feature.fasta' # feature information for training
ListTrainFeature = open(TrainFeaturePath,'r').readlines()
TestSequencePath = 'data\\' + splant + '\\Test dataset.fasta' # raw sequence information for test
ListTestSequence = open(TestSequencePath, 'r').readlines()
TestFeaturePath = 'data\\' + splant + '\\Test feature.fasta' # feature information for test
