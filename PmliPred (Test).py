...
splant = 'Arabidopsis lyrata' # plant species: 'Arabidopsis lyrata' or 'Solanum lycopersicum'
...
TestSequencePath = 'Datasets\\Test dataset\\' + splant + '\\Sequence.fasta' # raw sequence information for test
ListTestSequence = open(TestSequencePath, 'r').readlines()
TestFeaturePath = 'Datasets\\Test dataset\\' + splant + '\\Feature.fasta' # feature information for test
